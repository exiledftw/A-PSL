...
cells = [
    {
        ...
        "source": [
            ...
            "**Goal:** Mount your Google Drive, automatically scan the `Test Data/{label}/[videos]` directory, extract **208-dimensional MediaPipe landmark sequences**, apply **6× Data Augmentation**, and save the processed `.npy` dataset and ZIP file directly back to Google Drive.\n",
            "\n",
            "### 📁 Expected Google Drive Directory Structure:\n",
            "```\n",
            ...
            "\n",
            "### ⚡ Highlights for Colab:\n",
            "1. **Automatic GDrive Mounting & Path Resolver** (finds `Test Data` anywhere in Drive).\n",
            "2. **Fast MediaPipe Holistic Extraction** with real-time progress bars.\n",
            "3. **60-Frame Spline Temporal Resampling** (Matches SANA Conv1D tokenizer).\n",
            "4. **6× Data Augmentation** (Turns 400 recordings into 2,400+ distinct training samples).\n",
            "5. **Auto-Saves to Drive** so you never lose progress if Colab disconnects."
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "outputs": [],
        "source": [
            "# ── Cell 2: Auto-Detect 'Test Data' Folder in Google Drive & Configuration ────\n",
            "def find_test_data_folder(search_root=\"/content/drive/MyDrive\"):\n",
            "    \"\"\"\n",
            "    Automatically scans Google Drive to find the 'Test Data' folder.\n",
            "    \"\"\"\n",
            "    candidate_paths = [\n",
            ...
            "            return p\n",
            "            \n",
            "    # Recursive search if not in root of MyDrive\n",
            "    print(\"Searching Google Drive for 'Test Data' folder...\")\n",
            "    for root, dirs, files in os.walk(search_root):\n",
            "        for d in dirs:\n",
            "            if d.lower() in [\"test data\", \"test_data\", \"testdata\"]:\n",
            "                return os.path.join(root, d)\n",
            "                \n",
            "    return \"/content/drive/MyDrive/Test Data\"\n",
            "\n",
            "DETECTED_RAW_DIR = find_test_data_folder()\n",
            "\n",
            "CONFIG = {\n",
            "    # Input & Output Paths in Google Drive & Colab Local\n",
            "    \"RAW_VIDEOS_DIR\":       DETECTED_RAW_DIR,                     # Source folder: Test Data/{label}/[videos]\n",
            "    \"LOCAL_OUTPUT_DIR\":     \"/content/processed_psl_dataset\",     # Fast local SSD output\n",
            "    \"GDRIVE_BACKUP_DIR\":    \"/content/drive/MyDrive/SANA_PSL_Processed_Dataset\", # Permanent GDrive Backup\n",
            ...
            "    \"MIRROR_CORRECTION\":    True,                                 # Invert left/right if recorded with selfie camera\n",
            "    \n",
            ...
            "\n",
            "print(\"=\" * 60)\n",
            "print(f\"📂 Input Dataset Folder:      {CONFIG['RAW_VIDEOS_DIR']}\")\n",
            ...
            "    print(f\"⚠️ Warning: Folder '{CONFIG['RAW_VIDEOS_DIR']}' not found.\")\n",
            "    print(\"👉 Make sure your 'Test Data' folder is uploaded to Google Drive MyDrive!\")\n",
            "else:\n",
            "    labels = [d for d in os.listdir(CONFIG[\"RAW_VIDEOS_DIR\"]) if os.path.isdir(os.path.join(CONFIG[\"RAW_VIDEOS_DIR\"], d))]\n",
            "    print(f\"✅ Found {len(labels)} class subfolders in Test Data:\")\n",
            "    print(labels[:10] if len(labels) > 10 else labels)"
        ]
    },
    {
        "cell_type": "code",
    ...
    },
    {
        ...
        "outputs": [],
        "source": [
            "# ── Cell 6: Scan 'Test Data/{label}/[videos]' & Extract Keypoints ─────────────\n",
            "def scan_test_data_hierarchy(root_dir):\n",
            "    \"\"\"\n",
            "    Scans the exact structure: Test Data/{label}/[videos]\n",
            "    \"\"\"\n",
            ...
            "                for vpath in glob.glob(os.path.join(label_dir, ext)):\n",
            "                    samples.append({\n",
            "                        \"video_path\": vpath,\n",
            "                        \"label\": label_name,\n",
            ...
            "    return samples\n",
            "\n",
            "samples = scan_test_data_hierarchy(CONFIG[\"RAW_VIDEOS_DIR\"])\n",
            "print(f\"🔍 Found {len(samples)} videos across {len(set([s['label'] for s in samples]))} classes in '{CONFIG['RAW_VIDEOS_DIR']}'.\")\n",
            "\n",
            "if len(samples) == 0:\n",
            "    print(\"\\n⚠️ No video files found. Please ensure your folder path in Cell 2 matches your Google Drive folder!\")\n",
            "else:\n",
            ...
            "    \n",
            "    dataset_records = []\n",
            "    print(\"\\n🚀 Starting MediaPipe Landmark Extraction & Augmentation...\")\n",
            "    \n",
    ...
    },
    {
        ...
        "source": [
            ...
            "    print(f\"📄 Local Metadata saved: {local_csv_path}\")\n",
            "    \n",
...
print(f"Generated Colab-ready {out_path} with {len(cells)} cells.")
