"""
Generates SANA_PSL_Dataset_Probe.ipynb
A zero-assumption inspection and probing notebook for Pakistani Sign Language (PSL) datasets.
"""
import json
...
with open("e:/sign-language/Beta/SANA_PSL_Dataset_Probe.ipynb", "w", encoding="utf-8") as f:
    json.dump(notebook, f, indent=2)

print("Generated SANA_PSL_Dataset_Probe.ipynb successfully!")
